...
class APIClient:
    ...
    def team_transfers(self, team_id, from_date, to_date, details=None, fetch=None):
        """ Retrieves player transfers for each team """
        return self.loader.get_route_json('teams', team_id, 'transfers', toDate=to_date, fromDate=from_date, details=details, fetch=fetch)

    def player_matches(self, player_id, season_id, details=None, fetch=None):
        """ Returns the list of matches played by the given player in the any season. """
        return self.loader.get_route_json('players', player_id, 'matches', seasonId=season_id, details=details, fetch=fetch)
    ...
    def team_match_advancedstats(self, team_id, match_id):
        """
        Returns advanced statistics of a given player in a specific competition's
        season. The statistics provided are relative globally to the selected season,
        not to a specific team.
        """
        return self.loader.get_route_json('teams', team_id, 'matches',match_id, 'advancedstats')  
    ...
    def match_allplayers_advancedstats(self, match_id, details=None, fetch=None):
        """
        Returns advanced statistics of a given match
        """
        return self.loader.get_route_json('matches', match_id, 'advancedstats','players', details=details, fetch=fetch)
